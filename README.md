...
👋 I'm **Ganang Setyo Hadi**.

⚙️ A full-stack & AI engineer who ships things end-to-end.

🔭 I build at the intersection of AI and systems engineering.

[![views](https://komarev.com/ghpvc/?username=notsuperganang&style=flat&color=313131&label=views&abbreviated=true)](https://github.com/notsuperganang) [![linkedin](https://img.shields.io/badge/linkedin-ganang--setyo--hadi-313131?style=flat&labelColor=545454&color=313131&logo=linkedin)](https://linkedin.com/in/ganang-setyo-hadi)
...
| **AI & Full-Stack**                                                                                                                                                                                                                                                                                                                                         | **Platforms & Tools**                                                                                                                                                                                                                                                                                                                   |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| • [ocr-v3-telkom](https://github.com/notsuperganang/ocr-v3-telkom) - Full-stack web app to automate structured data extraction from Telkom contract PDFs. TypeScript + OCR pipeline.<br>• [PURRPAL](https://github.com/notsuperganang/PURRPAL) - AI-based cat health platform addressing veterinary access challenges in Indonesia. ML-heavy. | • [sikupi](https://github.com/notsuperganang/sikupi) - AI-powered marketplace transforming coffee waste into resources. Circular economy platform for Banda Aceh.<br>• [herbapedia](https://github.com/notsuperganang/herbapedia) - Comprehensive digital platform documenting Indonesia's traditional medicinal plants. TypeScript. |
...
**~** [_notsuperganang_](https://github.com/notsuperganang)
